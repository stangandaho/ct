...
![single camera representation](single_camera_representation.png)
...
![Instantaneous Sampling (ISE)](Instantaneous%20Sampling%20(ISE).png)
...
![Space-To-Event (STE)](Space-To-Event%20(STE).png)
...
![Space-To-Event (STE)](Time-To-Event%20(TTE).png)
