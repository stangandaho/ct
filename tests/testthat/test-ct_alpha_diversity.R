...
# Tests for ct_alpha_diversity function
test_that("ct_alpha_diversity works with basic shannon index", {

  result <- ct_alpha_diversity(
    data = test_data,
    site_column = site,
...
test_that("ct_alpha_diversity works with multiple indices", {
...
test_that("ct_alpha_diversity works with size_column", {
...
test_that("ct_alpha_diversity works with pre-computed community matrix", {
...
test_that("ct_alpha_diversity calculates simpson index correctly", {
...
test_that("ct_alpha_diversity calculates inverse simpson correctly", {
  community_data <- data.frame(
    site = c("Site1"),
    sp1 = c(5),
    sp2 = c(5)
...
test_that("ct_alpha_diversity calculates evenness correctly", {
  community_data <- data.frame(
    site = c("Site1"),
    sp1 = c(10),
    sp2 = c(10)
...
test_that("ct_alpha_diversity handles pielou index", {
  result <- ct_alpha_diversity(
    data = test_data,
    site_column = site,
    species_column = species,
...
test_that("ct_alpha_diversity handles single species correctly", {
...
test_that("ct_alpha_diversity handles empty sites", {
...
test_that("ct_alpha_diversity validates index parameter", {
  expect_error(
    ct_alpha_diversity(
      data = test_data,
      site_column = site,
...
test_that("ct_alpha_diversity works with different margin values", {
...
test_that("ct_alpha_diversity returns correct column names", {
...
test_that("ct_alpha_diversity preserves site names", {
...
test_that("ct_alpha_diversity handles NA values appropriately", {
  na_data <- data.frame(
...
test_that("ct_alpha_diversity works with different column selection methods", {
  # Test with numeric range
  result1 <- ct_alpha_diversity(
    data = community_matrix,
    site_column = site,
    species_column = 2:5,
    index = "shannon",
