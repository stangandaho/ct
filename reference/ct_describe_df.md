...
#> # A tibble: 4 × 12
#>   Group  Prop     N Variable   sum   Min `CI Right`   Max Median  Mean `CI Left`
#>   <chr> <dbl> <int> <chr>    <int> <dbl>      <dbl> <dbl>  <dbl> <dbl>     <dbl>
#> 1 NA       NA     2 y            7     3       9.85     4    3.5   3.5    -2.85 
#> 2 NA       NA     3 x            6     1       4.48     3    2     2      -0.484
