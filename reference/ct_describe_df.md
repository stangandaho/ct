...
#> # A tibble: 4 × 12
#>   Group  Prop     N Variable     sd   Min  Mean   Max `CI Right` Median
#>   <chr> <dbl> <int> <chr>     <dbl> <dbl> <dbl> <dbl>      <dbl>  <dbl>
#> 1 NA       NA     2 y         0.707     3   3.5     4       9.85    3.5
#> 2 NA       NA     3 x         1         1   2       3       4.48    2  
#> 3 A        75     3 z        NA        NA  NA      NA      NA      NA  
#> 4 B        25     1 z        NA        NA  NA      NA      NA      NA  
#> # ℹ 2 more variables: `CI Left` <dbl>, sum <int>
```
