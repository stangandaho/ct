...
#> # A tibble: 4 × 12
#>   Group  Prop     N Variable Median   sum   Min   Max  Mean `CI Left` `CI Right`
#>   <chr> <dbl> <int> <chr>     <dbl> <int> <dbl> <dbl> <dbl>     <dbl>      <dbl>
#> 1 NA       NA     2 y           3.5     7     3     4   3.5    -2.85        9.85
#> 2 NA       NA     3 x           2       6     1     3   2      -0.484       4.48
