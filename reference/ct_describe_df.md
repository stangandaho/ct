...
#> # A tibble: 4 × 12
#>   Group  Prop     N Variable Median   Min   Max  Mean `CI Left` `CI Right`   sum
#>   <chr> <dbl> <int> <chr>     <dbl> <dbl> <dbl> <dbl>     <dbl>      <dbl> <int>
#> 1 NA       NA     2 y           3.5     3     4   3.5    -2.85        9.85     7
#> 2 NA       NA     3 x           2       1     3   2      -0.484       4.48     6
