...
```{r echo=FALSE, fig.align='center', fig.alt='single camera representation', fig.cap="Figure 1: Schematic representation of a camera trap detection zone, showing the radial detection distance (r) and detection angle (θ) that define the camera’s viewshed area (also called field of view)", fig.alt='Single camera representation.png'}
knitr::include_graphics("single_camera_representation.png")
```
...
knitr::include_graphics("Instantaneous_Sampling.png")
```
...
knitr::include_graphics("Space_To_Event.png")
```
...
knitr::include_graphics("Time_To_Event.png")
```
