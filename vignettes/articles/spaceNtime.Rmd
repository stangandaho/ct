...
```{r echo=FALSE, fig.align='center', fig.alt='single camera representation', fig.cap="Figure 1: Schematic representation of a camera trap detection zone, showing the radial detection distance (r) and detection angle (θ) that define the camera’s viewshed area (also called field of view)"}
...
knitr::include_graphics("Instantaneous Sampling (ISE).png")
```
...
knitr::include_graphics("Space-To-Event (STE).png")
```
...
knitr::include_graphics("Time-To-Event (TTE).png")
```
