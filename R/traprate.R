...
#'               end_column = end)
#'
#' @seealso [ct_traprate_data()]
#'
#' @export
ct_get_effort <- function(deployment_data, # camera trap deployement data
...
#'                  )
#'
#' @seealso [ct_get_effort()]
#' @export
ct_traprate_data <- function(observation_data,
                             use_deployment = TRUE,
...
#'
#' @param data A data frame as returned by [ct_traprate_data()] with columns `n` and `effort`.
...
#'
#' @seealso [ct_get_effort()], [ct_traprate_data()]
#'
#' @export
ct_traprate_estimate <- function(data, # as outputted by ct_traprate_data
                                 strata = NULL,
                                 n_bootstrap = 1000
                                 )
  {
